package com.distributed_streaming_platform.user_service.config;
...
public class KafkaConsumerConfig {
    ...
    kafkaListenerContainerFactory() { ConcurrentKafkaListenerContainerFactory<String, UserCreatedEvent> factory
